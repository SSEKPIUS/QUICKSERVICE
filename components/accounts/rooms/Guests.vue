    ...
    <div ref="guest" class="flex w-full flex-row">
      <div class="w-full relative">
        <div class="w-full mx-auto pt-2">
          ...
          <div
            class=" w-full  rounded-xl overflow-x-scroll mb-10 min-h-full bg-white"
          >
            <div class="table w-full">
              <div class="w-full table-row-group">
                ...
                <!-- end of heading row -->
                <div
                  v-for="(guest, i) in allGuests.data"
                  :key="i"
                ...
                >
                  ...
                  <div class="table-cell">
                    <div class="m-3 uppercase whitespace-nowrap">
                      {{ guest.status }}
                    </div>
                  </div>
                  <div class="table-cell">
...
export default {
  ...
  methods: {
    ...mapActions(['loadGuestsPaginated']),
