<template>
  <div class="p-4 shadow bg-white rounded-lg group handle">
    ...
    <div class="text-lg text-gray-600 font-semibold">
      <div v-if="metric.increase" class="flex items-center">
        <span class="fe fe-trending-up text-green-600 font-bold" />
        <span class="ml-3 mr-2">{{ metric.percentage }}%</span> Increase
      </div>
      <div v-else class="flex items-center">
        <span class="fe fe-trending-down text-red-600 font-bold" />
        <span class="ml-3 mr-2">{{ metric.percentage }}%</span> Decrease
      </div>
    </div>
  </div>
</template>
