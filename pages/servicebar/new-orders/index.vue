...
export default {
  ...
  data () {
    return {
      tabs: [
        { name: 'NEW ORDERS', path: '/servicebar/new-orders', active: true, icon: 'fa fa-sort' },
  ...
  computed: {
    ...
    orders () {
      return filter(this.getOrders, function (o) { // 5 pending, 10 new  15 served 20 cancelling 25 cancelled
