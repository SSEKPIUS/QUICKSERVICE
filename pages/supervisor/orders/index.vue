<template>
  <div class=" min-w-min main">
    <div class="min-h-screen  flex flex-row">
      <TabTop :tabs="tabs" />
      <div class=" w-full p-2 text-center mx-auto">
        <Order :token="getToken" :users="getUsers" />
      </div>
    </div>
  </div>
</template>
...
import Order from '@/components/common/ordersUnfiltered/Order'
  ...
  data () {
    return {
      tabs: [
        ...
        { name: 'ORDERS', path: '/supervisor/orders', active: true, icon: 'fa fa-sort' },
